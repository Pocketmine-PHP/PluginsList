...
class Wild extends PluginBase implements Listener{
    ...
    public function onEnable() : void{
        ...
        $this->getLogger()->info("Wild " . self::VERSION . " by BlazeTheDev is enabled");
    }
    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool{
        if($command->getName() === "wild"){
            ...
            $sender->sendMessage(self::PREFIX . TextFormat::GREEN . "You have been teleported to coords " . TextFormat::AQUA . "X: $x | Y: 128 | Z: $z" . TextFormat::GREEN . " in the wild!");
